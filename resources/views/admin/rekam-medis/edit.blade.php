            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 space-y-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="tindakan" rows="2" placeholder="Tindakan medis atau resep yang diberikan..." 
                    ...
                    <div x-data="{ 
                        items: {{ $rekamMedi->reseps->map(fn($r) => ['obat_id' => $r->obat_id, 'jumlah' => $r->jumlah, 'aturan_pakai' => $r->aturan_pakai])->toJson() }},
                        addItem() {
                        ...
                        <div class="flex items-center justify-between">
                            <h4 class="text-sm font-black text-primary uppercase tracking-widest">E-Resep / Obat (Saat Ini)</h4>
                            <p class="text-[10px] text-orange-500 font-bold italic">*Mengedit resep di sini tidak akan mengembalikan stok obat lama secara otomatis.</p>
