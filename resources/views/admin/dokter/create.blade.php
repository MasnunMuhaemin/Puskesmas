...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 dark:text-white">Daftarkan tenaga medis baru ke dalam sistem.</p>
        </div>
        ...
        <form action="{{ route('admin.dokter.store') }}" method="POST" class="p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 space-y-2">
                    <label for="nama" class="text-sm font-bold text-gray-700 dark:text-white">Nama Lengkap Dokter (beserta Gelar)</label>
                    <input 
                        type="text" 
                        id="nama" 
                        name="nama" 
