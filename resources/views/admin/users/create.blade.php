...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 dark:text-white">Buat akun sistem baru.</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700 overflow-hidden" x-data="{ role: '{{ old('role', 'petugas') }}', showPass: false, showConfirm: false }">
        <form action="{{ route('admin.users.store') }}" method="POST" class="p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 space-y-2">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required class="block w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border-none rounded-2xl focus:ring-2 focus:ring-primary transition-all shadow-inner text-gray-900 dark:text-white">
                </div>

                <!-- Email -->
                <div class="md:col-span-2 space-y-2">
                    <label class="text-sm font-bold text-gray-700 dark:text-white">Email Login</label>
                    <input type="email" name="email" value="{{ old('email') }}" required class="block w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border-none rounded-2xl focus:ring-2 focus:ring-primary transition-all shadow-inner text-gray-900 dark:text-white">
                </div>
                ...
                <div class="space-y-2" x-show="role === 'pasien'" x-transition>
                    ...
                    <input type="text" name="nik" value="{{ old('nik') }}" :required="role === 'pasien'" maxlength="16" class="block w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border-none rounded-2xl focus:ring-2 focus:ring-primary transition-all shadow-inner font-mono text-gray-900 dark:text-white">
                </div>

                <!-- Password -->
                <div class="space-y-2">
                    <label class="text-sm font-bold text-gray-700 dark:text-white">Password</label>
                    <div class="relative">
                        <input 
                ...
                <!-- Confirm Password -->
                <div class="space-y-2">
                    <label class="text-sm font-bold text-gray-700 dark:text-white">Konfirmasi Password</label>
                    <div class="relative">
                        <input 
