...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Unit Poli</h1>
            <p class="text-gray-600 dark:text-gray-400">Daftarkan unit poliklinik baru ke sistem.</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700 overflow-hidden">
        <form action="{{ route('admin.poli.store') }}" method="POST" class="p-8 space-y-6">
            @csrf
