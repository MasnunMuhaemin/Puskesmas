...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Stok Obat</h1>
            <p class="text-gray-600 dark:text-gray-400">Input data obat baru ke dalam sistem.</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        <form action="{{ route('admin.obat.store') }}" method="POST" class="p-8 space-y-6">
            @csrf
